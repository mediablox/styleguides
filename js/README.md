# Mediablox JavaScript Style Guide() {

*A mostly reasonable approach to JavaScript*

> **Note**: this guide assumes you are using [Babel](https://babeljs.io), and requires that you use a [babel-preset]. It also assumes you are installing shims/polyfills in your app.
...
## Functions
  ...
  - [7.1](#functions--declarations) Use named function expressions instead of function declarations. eslint: [`func-style`](https://eslint.org/docs/rules/func-style)
    ...
    > Why? Function declarations are hoisted, which means that it’s easy - too easy - to reference the function before it is defined in the file. This harms readability and maintainability. If you find that a function’s definition is large or complex enough that it is interfering with understanding the rest of the file, then perhaps it’s time to extract it to its own module! Don’t forget to explicitly name the expression, regardless of whether or not the name is inferred from the containing variable (which is often the case in modern browsers or when using compilers such as Babel). This eliminates any assumptions made about the Error’s call stack. ([Discussion](https://github.com/mediablox/javascript/issues/794))
...
## Modules
  ...
  - [10.1](#modules--use-them) Always use modules (`import`/`export`) over a non-standard module system. You can always transpile to your preferred module system.
    ...
    ```javascript
    // bad
    const MediabloxStyleGuide = require('./MediabloxStyleGuide');
    module.exports = MediabloxStyleGuide.es6;

    // ok
    import MediabloxStyleGuide from './MediabloxStyleGuide';
    export default MediabloxStyleGuide.es6;

    // best
    import { es6 } from './MediabloxStyleGuide';
    export default es6;
    ```
  ...
  - [10.2](#modules--no-wildcard) Do not use wildcard imports.
    ...
    ```javascript
    // bad
    import * as MediabloxStyleGuide from './MediabloxStyleGuide';
  ...
  - [10.3](#modules--no-export-from-import) And do not export directly from an import.
    ...
    // bad
    // filename es6.js
    export { es6 as default } from './MediabloxStyleGuide';
...
## Whitespace
  ...
  - [19.13](#whitespace--max-len) Avoid having lines of code that are longer than 100 characters (including whitespace). Note: per [above](#strings--line-length), long strings are exempt from this rule, and should not be broken up. eslint: [`max-len`](https://eslint.org/docs/rules/max-len.html)
    ...
    // bad
    $.ajax({ method: 'POST', url: 'https://mediablox.com/', data: { name: 'John' } }).done(() => console.log('Congratulations!')).fail(() => console.log('You have failed this city.'));
...
## Commas
  ...
  - [20.2](#commas--dangling) Additional trailing comma: **Yup.** eslint: [`comma-dangle`](https://eslint.org/docs/rules/comma-dangle.html)
    ...
    > Why? This leads to cleaner git diffs. Also, transpilers like Babel will remove the additional trailing comma in the transpiled code which means you don’t have to worry about the [trailing comma problem](https://github.com/mediablox/javascript/blob/es5-deprecated/es5/README.md#commas) in legacy browsers.
...
## Type Casting & Coercion
  ...
  - [22.5](#coercion--bitwise) **Note:** Be careful when using bitshift operations. Numbers are represented as [64-bit values](https://es5.github.io/#x4.3.19), but bitshift operations always return a 32-bit integer ([source](https://es5.github.io/#x11.7)). Bitshift can lead to unexpected behavior for integer values larger than 32 bits. [Discussion](https://github.com/mediablox/javascript/issues/109). Largest signed 32-bit Int is 2,147,483,647:
...
## Naming Conventions
  ...
  - [23.8](#naming--PascalCase-singleton) Use PascalCase when you export a constructor / class / singleton / function library / bare object.
    ...
    ```javascript
    const MediabloxStyleGuide = {
      es6: {
      },
    };

    export default MediabloxStyleGuide;
    ```
...
## Testing
  ...
  - [30.2](#testing--for-real) **No, but seriously**:
    ...
    - We primarily use [`mocha`](https://www.npmjs.com/package/mocha) and [`jest`](https://www.npmjs.com/package/jest) at Mediablox. [`tape`](https://www.npmjs.com/package/tape) is also used occasionally for small, separate modules.
...
**Tools**
  ...
  - Code Style Linters
    - [ESlint](https://eslint.org/) - [Mediablox Style .eslintrc](https://github.com/mediablox/javascript/blob/master/linters/.eslintrc)
    - [JSHint](http://jshint.com/) - [Mediablox Style .jshintrc](https://github.com/mediablox/javascript/blob/master/linters/.jshintrc)
  - Neutrino Preset - [@neutrinojs/mediablox](https://neutrinojs.org/packages/mediablox/)
...
**Other Styles**
  ...
  - [Conditional Callbacks](https://github.com/mediablox/javascript/issues/52) - Ross Allen
...
## In the Wild
  ...
  - **Mediablox**: [mediablox/javascript](https://github.com/mediablox/javascript)
